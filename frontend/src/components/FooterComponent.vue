<template>
    <div class="footer">
        ...
        <div class="box-container">
            ...
            <div class="box">
                <h3>opening hours</h3>
                <p>everyday : 7:00am to 21:00pm</p>
        ...
        <div class="bottom">
            ...
            <div class="share">
                <a href="https://www.facebook.com/profile.php?id=100005264625400" class="fab fa-facebook-f" target="_blank"></a>
                ...
                <a href="https://github.com/huy12420" class="fa-brands fa-github" target="_blank"></a>
            </div>
